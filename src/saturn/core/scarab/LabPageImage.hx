...
/*
 * Corresponding table in database icmdb_labpage.LABPAGE_IMAGE
 *
...
class LabPageImage extends LabPageItem {
    public var content: String;
    public var imageEdit: Dynamic;
    public var imageAnnot: Dynamic;
    public var vectorized: Dynamic;
    public var elnProperties: Dynamic;
    public var annotTexts: String;
    public var wmf: Dynamic;
