...
class Ligation extends DNA{
	...
	public function setAcceptor(acceptor : DoubleDigest) {
		theAcceptor = acceptor;
	}
	
	public function setDonor(donor : DoubleDigest) {
		theDonor = donor;
	}
	
	public function calculateProduct() {
		if (theAcceptor != null && theDonor != null && 
				theAcceptor.getLeftProduct() != null && theDonor.getCenterProduct() != null && theAcceptor.getRightProduct() != null){
			setSequence(
