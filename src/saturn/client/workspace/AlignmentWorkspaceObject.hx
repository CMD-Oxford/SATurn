...
class AlignmentWorkspaceObject extends WorkspaceObjectBase<Alignment>{
    ...
    public function new(object : Dynamic, name : String){
        ...
        iconPath = '/static/js/images/aln_16.png';
    ...
    public function addSequenceNew(objectId : String){
        object.addObject(objectId);
    }

    public function removeSequenceNew(objectId : String){
        object.removeObject(objectId);
    }
