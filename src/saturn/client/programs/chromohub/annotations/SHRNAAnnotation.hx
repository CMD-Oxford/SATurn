...
class SHRNAAnnotation {
    ...
    static function hasshRNA(target: String, data: Dynamic, selected:Int, annotList:Array<PhyloAnnotation>, item:String, cb : HasAnnotationType->Void){
        //copy
        if(data!=null){
    ...
    static function divshRNA(screenData: PhyloScreenData, x:String, y:String, tree_type:String, callBack : Dynamic->Void){
