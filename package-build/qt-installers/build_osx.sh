...
cd ../../
/Users/sgcadmin/Qt/QtIFW-3.0.1/bin/binarycreator -c config/osx.config.xml -p packages SATurnOSXDeveloper --exclude linux.qt.x86_64,windows.developer_tools.x86_64,windows.haxe.x86_64,windows.tools.x86_64,windows.qt.x86_64,windows.server.x86_64,osx.single.app.x86_64
